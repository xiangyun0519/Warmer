  ...
  <div class="auth-page">
    ...
    <div class="container">
      ...
      <div class="auth-form">
        ...
        <p class="form-subtitle">注册后开始使用蓝境</p>
        ...
        <div class="form-section">
          ...
          <button 
            ...
            :disabled="!phone || !code || !nickname || loading"
          >
            {{ loading ? '注册中...' : '注册' }}
          </button>
        </div>
        ...
        <!-- 微信注册 -->
        <div class="form-section">
          <button class="btn-wechat" @click="registerByWechat">
...
const registerByPhone = async () => {
  ...
  loading.value = true
  try {
    await authStore.registerByPhone(phone.value, code.value, nickname.value)
    // 注册成功后会自动跳转到首页
  } catch (error) {
    alert('注册失败，请重试')
